...
/**
 *
 * Base Enum Code extracted from Ben Sampo's /laravel-enum package
 * @source https: //github.com/BenSampo/laravel-enum github repository
 * laravel-enum/src/Enum.php
 *
 */
